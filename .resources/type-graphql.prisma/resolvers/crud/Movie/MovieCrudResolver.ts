...
export class MovieCrudResolver {
  ...
  async aggregateMovie(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: AggregateMovieArgs,
  ): Promise<AggregateMovie> {
  ...
  async createManyMovie(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: CreateManyMovieArgs,
  ...
  async createManyAndReturnMovie(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: CreateManyAndReturnMovieArgs,
  ): Promise<CreateManyAndReturnMovie[]> {
    const { _count } = transformInfoIntoPrismaArgs(info);
  ...
  async createOneMovie(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: CreateOneMovieArgs,
  ): Promise<Movie> {
    const { _count } = transformInfoIntoPrismaArgs(info);
  ...
  async deleteManyMovie(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: DeleteManyMovieArgs,
  ): Promise<AffectedRowsOutput> {
    const { _count } = transformInfoIntoPrismaArgs(info);
  ...
  async deleteOneMovie(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: DeleteOneMovieArgs,
  ): Promise<Movie | null> {
    const { _count } = transformInfoIntoPrismaArgs(info);
  ...
  async findFirstMovie(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: FindFirstMovieArgs,
  ): Promise<Movie | null> {
    const { _count } = transformInfoIntoPrismaArgs(info);
  ...
  async findFirstMovieOrThrow(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: FindFirstMovieOrThrowArgs,
  ): Promise<Movie | null> {
    const { _count } = transformInfoIntoPrismaArgs(info);
  ...
  async movie(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: FindUniqueMovieArgs,
  ): Promise<Movie | null> {
    const { _count } = transformInfoIntoPrismaArgs(info);
  ...
  async getMovie(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: FindUniqueMovieOrThrowArgs,
  ): Promise<Movie | null> {
    const { _count } = transformInfoIntoPrismaArgs(info);
  ...
  async groupByMovie(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: GroupByMovieArgs,
  ): Promise<MovieGroupBy[]> {
  ...
  async updateManyMovie(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: UpdateManyMovieArgs,
  ): Promise<AffectedRowsOutput> {
    const { _count } = transformInfoIntoPrismaArgs(info);
  ...
  async updateOneMovie(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: UpdateOneMovieArgs,
  ): Promise<Movie | null> {
    const { _count } = transformInfoIntoPrismaArgs(info);
  ...
  async upsertOneMovie(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: UpsertOneMovieArgs,
  ): Promise<Movie> {
    const { _count } = transformInfoIntoPrismaArgs(info);
